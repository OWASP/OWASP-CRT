...
const TerminalEngine = ({ startFlow }) => {
  ...
  return (
    <div className="bg-transparent p-[15px] md:p-[20px] font-['Fira_Code',monospace] text-[12px] md:text-[13px] text-slate-200 h-full overflow-y-auto rounded-b-[9px] cursor-text flex flex-col leading-[1.6]" onClick={handleContainerClick}>
      <div id="term-output">
        ...
        <div className="flex flex-col gap-1.5 mt-1.5 w-full">
          ...
          <div className="flex items-center flex-wrap w-full">
            ...
            <input
              type="text"
              ref={firstNameRef}
              className="bg-transparent border-none outline-none text-white font-['Fira_Code',monospace] text-[12px] md:text-[13px] flex-grow ml-2 caret-[#4a7bfe]"
              value={firstName}
              onChange={(e) => {
